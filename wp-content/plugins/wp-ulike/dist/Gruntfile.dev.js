  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      chartjs: {
        files: [{
          ...
          cwd: '<%= pkg.bower.components %>chart.js/dist',
      ...
      vueJs: {
        files: [{
          expand: true,
          // Enable dynamic expansion.
          cwd: '<%= pkg.bower.components %>vue/dist',
          // Src matches are relative to this path.
      ...
      matchHeight: {
        files: [{
          expand: true,
          // Enable dynamic expansion.
          cwd: '<%= pkg.bower.components %>matchHeight/dist',
          // Src matches are relative to this path.
    ...
    concat: {
      frontJsScripts: {
        ...
        src: ['assets/js/src/wordpress-ulike-notifications.js', 'assets/js/src/wordpress-ulike.js', 'assets/js/src/scripts.js'],
