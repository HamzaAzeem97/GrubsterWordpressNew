...
global $wpra_lite;
?>
<div class="wpreactions primary-color-blue wpra-global-options">
    <!-- floating preview -->
	<?php
	Helper::getTemplate(
        ...
        <div id="global-behavior-chooser" class="mt-3">
            <div class="wpra-option-heading d-flex align-items-center justify-content-between heading-left">
                <div>
                    ...
                    <span><?php _e('Get started by turning on the toggle to deploy your emoji reactions sitewide. Click customize now to override factory settings.', 'wpreactions-lite'); ?></span>
                </div>
	...
	<?php } else {
		switch ( $_GET['behavior'] ) {
			case "button_reveal":
				Helper::getTemplate( 'view/admin/steps/global-reveal-button-steps' );
				break;
			default:
