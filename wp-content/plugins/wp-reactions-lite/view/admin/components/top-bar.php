...
?>
<div class="wpra-options-header">
    <div class="logo-wrap">
        <span class="dashicons dashicons-menu floating-menu-toggler"></span>
        <img class="wpj-logo" src="https://wpreactions.com/wp-content/themes/wpjt/assets/images/logo-for-lite.svg" alt="Logo">
    ...
    <div class="nav-links-wrap">
        <nav class="header-links d-inline-block">
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link" href="https://wpreactions.com/lite?page=documentation" target="_blank">
                        <span><?php _e('Documentation', 'wpreactions-lite'); ?></span>
                        <span class="dashicons dashicons-external"></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="https://wpreactions.com/lite?page=support" target="_blank">
...
<div class="top-section-title-mobile">
    <div class="top-section-title">
        <span class="tt-1"><?php echo $section_title; ?></span>
		<?php if ( isset( $_GET['behavior'] ) ) { ?>
            <span class="tt-2"><?php _e('Classic Reactions Lite','wpreactions-lite'); ?></span>
